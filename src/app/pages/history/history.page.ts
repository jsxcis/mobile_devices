...
export class HistoryPage implements OnInit {
 ...
 public postData = {
  ...
  showTankHistory(deviceID:string,item)
  {
   ...
   // console.log(item.deviceLevel);
    ...
    this.router.navigate(['home/tank-history'],navigationExtras);
  }
  showBoreHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
   // console.log("showDetail");
   // console.log(item.deviceID);
  //  console.log(item.deviceLevel);
    ...
    this.router.navigate(['home/bore-history'],navigationExtras);
  }
  showTroughHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
  //  console.log("showDetail");
  //  console.log(item.deviceID);
  //  console.log(item.deviceLevel);
    ...
    this.router.navigate(['home/trough-history'],navigationExtras);
  }
  showFenceHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
   // console.log("showDetail");
   // console.log(item.deviceID);
   // console.log(item.deviceLevel);
    ...
    this.router.navigate(['home/fence-history'],navigationExtras);
  }
  showWeatherStnHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
   // console.log("showDetail");
   // console.log(item.deviceID);
   // console.log(item.deviceMode);
    ...
    this.router.navigate(['home/weather-history'],navigationExtras);
  }
  showRainGaugeHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
   // console.log("showRainGaugeHistory");
  //  console.log(item.deviceID);
   // console.log(item.deviceMode);
    let navigationExtras: NavigationExtras = {
      queryParams: {
    ...
    this.router.navigate(['home/rainGauge-history'],navigationExtras);
  }
  showFlowMeterHistory(deviceID:string,item)
  {
    this.deviceID = deviceID;
  //  console.log("showFlowMeterHistory");
   // console.log(item.deviceID);
   // console.log(item.deviceMode);
    let navigationExtras: NavigationExtras = {
      queryParams: {
    ...
    this.router.navigate(['home/flowMeter-history'],navigationExtras);
  }
  loadRainGauges()
  {
